...
Here's a fact that should shock every American: [The Supreme Court's nine justices are the only federal judicial officers who are not subject to a specific and binding code of ethics](https://www.congress.gov/crs-product/LSB11078).

Every other federal judge in America—from district courts to circuit courts of appeals—faces enforceable ethical rules and potential discipline for violations. [All fifty state supreme courts](https://www.whitehouse.senate.gov/news/release/new-whitehouse-report-finds-supreme-court-alone-among-u-s-high-courts-with-no-enforcement-mechanism-for-ethics-violations/) subject their justices to ethics reviews with real consequences.

<!--more-->

But the nine most powerful judges in America? They answer to no one.

On November 13, 2023, facing mounting pressure from ethics scandals involving Justices Thomas and Alito, [the Supreme Court adopted its first-ever written code of conduct](https://www.propublica.org/article/supreme-court-adopts-ethics-code-scotus-thomas-alito-crow). The justices presented it as a meaningful reform.

It wasn't. The code has [no enforcement mechanism](https://www.brennancenter.org/our-work/analysis-opinion/new-supreme-court-ethics-code-designed-fail), no independent oversight, and no penalties for violations. It's advisory, not mandatory. [With 53 uses of the word "should" and only 6 of the word "must,"](https://www.americanprogress.org/article/with-its-release-of-a-new-nonbinding-code-of-conduct-the-supreme-court-fails-on-ethics-again/) it reads more like a friendly suggestion than binding rules.

As Senator Sheldon Whitehouse stated: ["This is a long-overdue step by the justices, but a code of ethics is not binding unless there is a mechanism to investigate possible violations and enforce the rules."](https://www.propublica.org/article/supreme-court-adopts-ethics-code-scotus-thomas-alito-crow)
...
The Supreme Court's November 2023 code represents the justices policing themselves. There is [no mechanism to enforce the code—no arbiter to enforce, apply, or even interpret these rules](https://www.brennancenter.org/our-work/analysis-opinion/new-supreme-court-ethics-code-designed-fail).
...
[Law professor Stephen Vladeck](https://www.npr.org/2023/11/13/1212708142/supreme-court-ethics-code) captured the absurdity: "The new Supreme Court code's lack of any apparent enforcement process is 'the elephant in the room.' Even the most stringent and aggressive ethics rules don't mean all that much if there's no mechanism for enforcing them."
...
Since 1973, [judges on the lower federal courts have been subject to ethical canons](https://www.uscourts.gov/judges-judgeships/code-conduct-united-states-judges) now known as the Code of Conduct for United States Judges. The code addresses:
...
More importantly, violations can trigger discipline under the [Judicial Conduct and Disability Act of 1980](https://www.fjc.gov/history/timeline/judicial-conduct-and-disability-act).
...
Here's the catch: [Neither the Code of Conduct for United States Judges nor the Judicial Conduct and Disability Act applies to the Justices of the Supreme Court](https://www.congress.gov/crs-product/LSB11078).
...
[All fifty states have enforceable judicial ethics codes—including those that bind their highest courts](https://www.whitehouse.senate.gov/news/release/new-whitehouse-report-finds-supreme-court-alone-among-u-s-high-courts-with-no-enforcement-mechanism-for-ethics-violations/). By 1980, all 50 states had established commissions with authority to investigate judicial misconduct and impose discipline.
...
[Every state supreme court subjects its judges or justices to ethics reviews](https://www.whitehouse.senate.gov/news/release/new-whitehouse-report-finds-supreme-court-alone-among-u-s-high-courts-with-no-enforcement-mechanism-for-ethics-violations/)—something the U.S. Supreme Court refuses to do.
...
Congress has proposed exactly the kind of binding ethics code the Supreme Court needs: the [Supreme Court Ethics, Recusal, and Transparency Act (SCERT Act)](https://www.whitehouse.senate.gov/news/release/whitehouse-johnson-colleagues-reintroduce-supreme-court-ethics-recusal-and-transparency-act/).

Reintroduced in May 2025 by Senator Sheldon Whitehouse and Representative Hank Johnson, [the Act includes](https://www.congress.gov/bill/119th-congress/house-bill/3513/text):
...
[Legal scholars across the political spectrum](https://www.nycbar.org/reports/the-supreme-court-needs-a-mandatory-and-enforceable-code-of-ethics/) agree that Congress has constitutional authority to impose ethics requirements on the Supreme Court. The justices' resistance is about protecting their privilege, not the Constitution.
...
The code's commentary explicitly excuses the very conduct that triggered its creation. On gifts and disclosure, [the code says](https://www.supremecourt.gov/about/Code-of-Conduct-for-Justices_November_13_2023.pdf) justices "may accept personal hospitality" without disclosure—the exact loophole Thomas used to justify hiding millions in luxury travel.

[As critics immediately noted](https://www.brennancenter.org/our-work/analysis-opinion/new-supreme-court-ethics-code-designed-fail), the Court designed the code to retroactively justify the justices' problematic conduct rather than prevent future violations.

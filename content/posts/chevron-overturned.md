...
The Chevron doctrine comes from the 1984 Supreme Court case [*Chevron v. Natural Resources Defense Council*](https://www.nrdc.org/stories/what-happens-if-supreme-court-ends-chevron-deference). The decision established a simple, practical framework: when Congress passes a law that contains ambiguities or technical gaps, and a regulatory agency fills those gaps with a reasonable interpretation, courts should defer to the agency's expertise.
...
[Under Chevron, courts applied a two-step test](https://www.law.cornell.edu/wex/chevron_deference):

1. Has Congress directly spoken to the precise question at issue? If yes, follow Congress's intent.
2. If the statute is ambiguous or silent, does the agency's interpretation seem reasonable? If yes, defer to the agency.
...
For 40 years, Chevron deference was [a cornerstone of administrative law](https://govfacts.org/explainer/the-end-of-chevron-how-the-supreme-court-changed-who-rules-america/), allowing expert agencies to protect public health, workplace safety, environmental quality, and consumer rights.
...
Justice Elena Kagan wrote a scathing dissent, warning that the decision would create regulatory chaos and substitute judicial policymaking for expert agency judgment. She noted that [Congress deliberately delegates authority to agencies](https://news.stanford.edu/stories/2024/08/deborah-sivas-on-chevron-and-the-future-of-regulation) precisely because they have expertise courts lack.
...
The immediate consequence of *Loper Bright* is an explosion of litigation. [Anyone who doesn't like a federal regulation can now bring it before a court](https://slate.com/business/2024/07/chevron-deference-federal-agencies-expert-regulators-epa-osha-ftc-atf-fda.html), arguing that the agency interpreted the law incorrectly.
...
**Food and drug safety**: The FDA interprets ambiguous statutory language about what constitutes "safe and effective" drugs, medical devices, and food additives. While [drug approval standards may remain intact](https://www.whitecase.com/insight-alert/us-supreme-court-strikes-down-chevron-doctrine-what-you-need-know), countless other FDA interpretations are now vulnerable to challenge.
...
As a [former EPA regional counsel warned](https://slate.com/business/2024/07/chevron-deference-federal-agencies-expert-regulators-epa-osha-ftc-atf-fda.html), if agencies have to litigate every enforcement action rather than issuing administrative orders, "the enforcement program is going to collapse."
...
[As experts note](https://www.ppic.org/blog/unpacking-the-supreme-courts-recent-ruling-on-the-chevron-doctrine/), "the idea behind such deference is that expert agencies, accountable to an elected president, are better suited than federal judges to make the policy choices that Congress left open."
...
The decision creates [uncertainty and instability across the entire regulatory system](https://slate.com/business/2024/07/chevron-deference-federal-agencies-expert-regulators-epa-osha-ftc-atf-fda.html).
...
[Courts will likely experience an initial spike in litigation](https://www.whitecase.com/insight-alert/us-supreme-court-strikes-down-chevron-doctrine-what-you-need-know) as parties who previously declined to sue based on Chevron deference now reevaluate their odds of successfully challenging agency interpretations.
...
The Supreme Court has knocked out [a core pillar of American administrative law and created a real risk of regulatory chaos](https://slate.com/business/2024/07/chevron-deference-federal-agencies-expert-regulators-epa-osha-ftc-atf-fda.html) across environmental protection, health care, labor standards, land use, and corporate reporting.

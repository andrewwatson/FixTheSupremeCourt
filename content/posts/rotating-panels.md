...
draft = false
title = "Rotating Judicial Panels: A Bold Solution to Supreme Court Partisanship"
author = 'Editor'
weight = 10
...
The idea is elegant: instead of nine permanent justices deciding every case, [the Supreme Court would hear cases in panels of nine randomly selected](https://www.washingtonpost.com/politics/2021/04/15/4-ideas-supreme-court-reform/) from a larger pool of federal judges. No more lifetime appointments determining decades of legal doctrine. No more single vacancies triggering political warfare.
...
The most comprehensive version, often called the ["Supreme Court Lottery,"](https://www.commoncause.org/illinois/articles/policy-analysis-the-supreme-court-lottery/) would work like this:

1. **All federal appeals court judges become Associate Justices** - [All 179 judges on the federal courts of appeals](https://nickcoccoma.substack.com/p/lotteries-and-the-supreme-court) would be appointed as associate justices of the Supreme Court (along with the existing nine, for a total of 188 justices)
...
3. **Two-week rotations** - [One proposal involves rotating panels serving for just two weeks](https://www.washingtonpost.com/politics/2021/04/15/4-ideas-supreme-court-reform/), after which a new panel of nine would be randomly selected

4. **Partisan balance requirements** - [No more than five justices on a nine-justice panel could be appointed by presidents of one political party](https://www.washingtonpost.com/politics/2021/04/15/4-ideas-supreme-court-reform/), preventing ideologically stacked panels

### Modified Proposal: Adding Four Rotating Judges

A less dramatic version would [add four randomly assigned circuit court judges per term](https://nyulawreview.org/forum/2022/03/shuffling-the-deck-for-a-fairer-game-a-modest-proposal-to-fix-the-supreme-court-by-adding-four-randomly-assigned-circuit-court-judges-per-term/) to the existing nine permanent justices. This creates a 13-member pool, with panels still consisting of nine justices.
...
[Cases in United States courts of appeals are typically heard by three-judge panels](https://govfacts.org/explainer/en-banc-vs-panel-decisions-how-federal-appeals-courts-work/), randomly chosen from the sitting appeals court judges of that circuit. A circuit might have 15 or 20 active judges, but each case is decided by just three.
...
[The Ninth Circuit's en banc panels](https://legalclarity.org/how-the-ninth-circuit-court-of-appeals-works/) consist of the Chief Judge plus 10 additional active judges selected at random (rather than all 29 judges participating). The Fifth Circuit adopted a similar procedure in 1986.

Federal law explicitly authorizes this: for courts with more than 15 judges, [an en banc hearing may consist of "such number of members as may be prescribed by rule of the court."](https://en.wikipedia.org/wiki/En_banc)
...
When there are [nearly 200 potential justices who might sit on any particular case](https://nickcoccoma.substack.com/p/lotteries-and-the-supreme-court), individual appointments matter far less.
...
The proposal would ["de-politicize the appointments process"](https://nickcoccoma.substack.com/p/lotteries-and-the-supreme-court) and diminish the significance of Supreme Court appointments in presidential elections.
...
When nine permanent justices decide every case, [research shows that assigning three Democrats to a court of appeals panel, compared to three Republicans, more than quintupled the chances](https://isps.yale.edu/research/publications/isps09-031) that the Supreme Court would overturn that decision.
...
[Congress has broad authority to set or change the size of the Supreme Court](https://www.congress.gov/crs-product/R47382) through ordinary legislation. The Court has been as small as five justices and as large as ten. If Congress can set the number at nine, it can set it at 188.
...
Federal statute already authorizes circuit courts to create panels through rules—including random selection for en banc panels in large circuits. [Congress' passage of the Judiciary Acts](https://nickcoccoma.substack.com/p/lotteries-and-the-supreme-court) indicates its power to control the structure of the federal courts.
...
The biggest concern: [randomness could create panels "stacked in favor of judges nominated by one side"](https://www.washingtonpost.com/politics/2021/04/15/4-ideas-supreme-court-reform/) deciding extremely important cases.
...
[Research on state supreme courts](https://www.nber.org/papers/w22071) found that judicial selection reforms changing from partisan to merit-based systems produced judges that provided higher-quality work than their pre-reform colleagues.

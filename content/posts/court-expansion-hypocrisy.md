...
title = "Republicans Call Supreme Court Expansion 'Unconstitutional.' Then They Packed Utah's Court Last Week."
author = 'Editor'
weight = 10

tags = ["reform", "hypocrisy", "partisanship", "court expansion"]

[cover]
image = "/headers/court-expansion-hypocrisy_modern.png"
alt = "Republican hypocrisy on court expansion"
+++
...
1. **Whether the current Court is legitimate** given how its composition came about
2. **Whether nine justices make sense** for a nation of 335 million people
3. **How to prevent either party from manipulating the judiciary** for partisan gain
4. **What structural reforms** (term limits, ethics enforcement, transparency) would restore public trust

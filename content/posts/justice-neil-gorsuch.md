...
[cover]
image = "/headers/justice-neil-gorsuch_modern.png"
alt = "Neil Gorsuch official Supreme Court portrait style illustration"
+++
...
Gorsuch's record makes the case for disclosure reform specifically: a rule requiring transaction counterparties to be identified without exception, verified independently rather than self-reported, would have surfaced the Duffy connection in 2017 rather than 2023. [A binding ethics code with real investigative authority](/posts/binding-ethics-code/) would also remove the current dependence on journalists to catch conflicts before a justice is forced to address them — recusal that only happens after public pressure is not a functioning accountability system, it's a public-relations response to one.

---

### Sources

- [CNN: "Justice Neil Gorsuch's property sale to prominent lawyer raises more ethical questions"](https://www.cnn.com/2023/04/25/politics/gorsuch-property-sale-lawyer-ethics/index.html)
- [Washington Post: "Gorsuch property sale renews calls for Supreme Court ethics reform"](https://www.washingtonpost.com/politics/2023/04/25/neil-gorsuch-property-sale-law-firm-ethics/)
- [Axios: "More ethics questions rise for Supreme Court justices"](https://www.axios.com/2023/04/25/neil-gorsuch-property-sale)
- [Balls and Strikes: "Neil Gorsuch's Property Sale Shows How Broken Supreme Court Disclosure Rules Are"](https://ballsandstrikes.org/ethics-accountability/neil-gorsuch-property-the-rules-are-the-problem/)
- [Newsweek: "Supreme Court Justice Neil Gorsuch Recuses Himself From Case After Pressure"](https://www.newsweek.com/supreme-court-justice-neil-gorsuch-recuses-himself-case-after-pressure-1995752)
- [Revolving Door Project: "Justice Gorsuch's Recusal Shows Other Justices Have Missed Recusals"](https://therevolvingdoorproject.org/release-justice-gorsuchs-recusal-shows-other-justices-have-missed-recusals/)
- [Slate: "Supreme Court ethics: Neil Gorsuch's abrupt recusal means little"](https://slate.com/news-and-politics/2024/12/supreme-court-ethics-neil-gorsuch-recusal.html)
